...
The cloud provider manages the infrastructure such as Virtual Machines (VMs), networking, storage, operating system, runtime, and middleware. Developers focus only on writing and deploying applications.
